...
module.exports = function (options) {
    ...
    const APP_CONFIG = require(process.env.ANGULAR_CONF_FILE || (isProd
                                                                 ? './config.prod.json'
                                                                 : './config.dev.json'));
        ...
        module: {
            ...
            rules: [
                ...
                */
                ...
                {
                    test: /\.(mp4|mpeg|avi|wmv)$/,
                    use : 'file-loader?name=assets/video/[name].[ext]'
                },

                {
                    test: /\.cur$/,
                    use : 'file-loader?name=assets/cursors/[name].[ext]'
                },
