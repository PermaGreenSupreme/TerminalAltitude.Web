...
export class ClockPickerComponent implements OnInit, AfterViewInit, ControlValueAccessor {
    ...
    setHand(x: any, y: any, roundBy5: any) {
        ...
        if (isHours) {
            this.fg.nativeElement.setAttribute('class', 'clockpicker-space_station_canvas-fg');
        } else {
            if (value % 5 === 0) {
                this.fg.nativeElement.setAttribute('class', 'clockpicker-space_station_canvas-fg');
            } else {
                this.fg.nativeElement.setAttribute('class', 'clockpicker-space_station_canvas-fg active');
            }
        }
